...
function Home2Service() {
  return (
    <section id="home2-service" className="text-center text-[#8B8B8B] pt-39 pb-32 max-w-[71.25rem] mx-auto max-lg:py-16 max-sm:py-12">
        ...
        <div id="service-detail" className="flex flex-row justify-around pt-2 px-22 gap-4 h-[19.3rem] max-lg:h-auto max-lg:flex-wrap max-lg:justify-center max-sm:flex-col max-sm:items-center max-sm:px-8">
            <div className="service-card flex flex-col items-start text-left gap-2 w-[16.3125rem] px-9 py-[2rem] border rounded-3xl bg-white 
            max-lg:w-[18rem] max-lg:px-6 max-lg:py-12 max-sm:w-full max-sm:max-w-[20rem] max-sm:px-4 max-sm:py-10 max-sm:items-center">
            ...
            <div className="service-card flex flex-col items-start text-left gap-2 w-[16.3125rem] px-9 py-[2rem] border border-[var(--bold-text-color)] rounded-3xl bg-white
            max-lg:w-[18rem] max-lg:px-6 max-lg:py-12 max-sm:w-full max-sm:max-w-[20rem] max-sm:px-4 max-sm:py-10 max-sm:items-center">
