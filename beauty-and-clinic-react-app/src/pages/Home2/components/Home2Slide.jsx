    ...
    <section id='home2-slide' className='text-white max-w-[71.25rem] mx-auto'>
        ...
        max-[768px]:flex-col max-[768px]:text-center max-[768px]:items-center max-[768px]:px-4 max-[768px]:py-0">
            ...
            max-lg:pt-4 max-lg:pl-2 max-md:items-center">
                ...
                max-[768px]:text-[15px] max-[540px]:hidden">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Commodo, massa pellentesque arcu fusce et magna consequat neque vitae lobortis.</h3>
                <button id="more-detail" className="text-white font-semibold mt-[2.1rem] tracking-[0.1rem] border rounded-xl px-[1.9rem] h-[52px] cursor-pointer
                max-[1024px]:mt-4
