...
import professional_card_img_1 from '../assets/img/professional/professional-card-img-1.png'
import professional_card_img_2 from '../assets/img/professional/professional-card-img-2.png'
import professional_card_img_3 from '../assets/img/professional/professional-card-img-3.png'
import twitter_icon from '../assets/icon/twitter-icon.svg'
import facebook_icon from '../assets/icon/facebook-icon.svg'
import ig_icon from '../assets/icon/instagram-icon.svg'
