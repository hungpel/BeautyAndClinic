...
export default function Header() {
  ...
  return (
    <section id="top-section" className="relative max-w-[1440px] mx-auto">
      <header id="header" className='mx-auto pt-[30px] pb-[29px] flex justify-between items-center text-[#8B8B8B] tracking-[0.1em] max-w-[71.5rem]
        max-lg:flex-row max-lg:items-center max-lg:p-6
        max-md:px-0
        max-sm:flex-col max-sm:justify-center max-sm:items-center max-sm:p-4'>
        <div id="left-header" className='min-w-[180px] pt-[11px] mr-[20px] max-lg:w-full max-lg:pt-0 max-md:flex max-md:w-[80%] max-md:pt-0 max-sm:flex max-sm:items-center max-sm:justify-between max-sm:w-[80%] max-sm:mr-0 max-sm:my-5'>
          <img src={top_logo} alt="top-logo-img" className='' />
          <div className="max-sm:block sm:hidden border border-3 rounded-lg border-sky-800 min-w-[2rem]" onClick={toggleMenu}>
